...
declare module '$env/static/private' {
	...
	export const npm_config__dnb_web_infrastructure_registry: string;
	...
	export const npm_config__dnb_shared_tools_registry: string;
	export const npm_execpath: string;
	export const PAGER: string;
	export const npm_package_devDependencies_svelte: string;
	export const npm_config__dnb_shared_libs_registry: string;
	...
	export const npm_config__nucleus_registry: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_config__dnb_web_infrastructure_registry: string;
		...
		npm_config__dnb_shared_tools_registry: string;
		npm_execpath: string;
		PAGER: string;
		npm_package_devDependencies_svelte: string;
		npm_config__dnb_shared_libs_registry: string;
		LSCOLORS: string;
		...
		npm_config__nucleus_registry: string;
